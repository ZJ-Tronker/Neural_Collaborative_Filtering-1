...
class NeuCf:
    ...
    def __init__(self, args):
        ...
        self.mf_dim = args.num_factors
        self.layers = eval(args.layers)
        self.reg_mf = args.reg_mf
        self.reg_layers = eval(args.reg_layers)
        self.num_negatives = args.num_neg
        self.learning_rate = args.lr
        self.learner = args.learner
        self.verbose = args.verbose
        self.mf_pretrain = args.mf_pretrain
        self.mlp_pretrain = args.mlp_pretrain
    ...
    def get_model(num_users, num_items, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
        ...
        for idx in range(1, num_layer):
            layer = Dense(layers[idx], kernel_regularizer=l2(reg_layers[idx]), activation='relu',
                          name="layer%d" % idx)
